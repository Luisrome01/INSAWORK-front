...
const ModalHistoria = ({ closeModal }) => {
  ...
  const handleDeleteTreatment = async (treatmentId) => {
    try {
      ...
      setTreatments((prevTreatments) =>
        prevTreatments.filter((treatment) => treatment._id !== treatmentId)
      );
    } catch (error) {
    ...
    const fetchExternalExams = async () => {
      try {
        ...
        const response = await fetch(
          `https://insawork.onrender.com/externalExams/${medicalRecordId}`
        );
        if (response.ok) {
  ...
  useEffect(() => {
    const fetchMedicalRecord = async () => {
      try {
        const response = await fetch(
          `https://insawork.onrender.com/medicalRecord/${selectedPatientId}`
        );
        if (response.ok) {
          const data = await response.json();
          if (data.length > 0) {
  ...
  const handleSave = async () => {
    try {
      const response = await fetch(
        `https://insawork.onrender.com/medicalRecord/${medicalRecord._id}`,
        {
          method: "PUT",
    ...
    <div className="historia-modal-overlay">
      <div className="historia-modal">
        <div className="pacienteHeaderModal">
          <h2 className="createMedicineModalTitle">Historia Médica</h2>
          <button className="usuarioCloseButton" onClick={handleCancel}>
            <FaTimes />
          </button>
        </div>
            ...
            <div>
              ...
              <div className="historia-modal-input-group">
                ...
                <input
                  ...
                  value={
                    isEditing
                      ? newRecord.ant_medicos
                      : medicalRecord
                      ? medicalRecord.ant_medicos
                      : ""
                  }
                  onChange={handleInputChange}
                  disabled={!isEditing}
              ...
              <div className="historia-modal-input-group">
                ...
                <input
                  ...
                  value={
                    isEditing
                      ? newRecord.ant_familiares
                      : medicalRecord
                      ? medicalRecord.ant_familiares
                      : ""
                  }
                  onChange={handleInputChange}
                  disabled={!isEditing}
              ...
              <div className="historia-modal-input-group">
                ...
                <input
                  ...
                  value={
                    isEditing
                      ? newRecord.ant_laborales
                      : medicalRecord
                      ? medicalRecord.ant_laborales
                      : ""
                  }
                  onChange={handleInputChange}
                  disabled={!isEditing}
              ...
              <div className="historia-modal-input-group">
                ...
                <input
                  ...
                  name="alergias"
                  value={
                    isEditing ? newRecord.alergias : medicalRecord ? medicalRecord.alergias : ""
                  }
                  onChange={handleInputChange}
                  disabled={!isEditing}
                />
              ...
              <div className="historia-modal-input-group">
                ...
                <input
                  ...
                  value={
                    isEditing
                      ? newRecord.enf_cronicas
                      : medicalRecord
                      ? medicalRecord.enf_cronicas
                      : ""
                  }
                  onChange={handleInputChange}
                  disabled={!isEditing}
              ...
              <div className="historia-modal-input-group">
                ...
                <input
                  ...
                  value={
                    isEditing
                      ? newRecord.habits.alcohol
                      : medicalRecord
                      ? medicalRecord.habits.alcohol
                      : ""
                  }
                ...
                <input
                  ...
                  value={
                    isEditing
                      ? newRecord.habits.estupefacientes
                      : medicalRecord
                      ? medicalRecord.habits.estupefacientes
                      : ""
                  }
                  onChange={handleHabitChange}
                  disabled={!isEditing}
                ...
                <input
                  ...
                  value={
                    isEditing
                      ? newRecord.habits.actividad_fisica
                      : medicalRecord
                      ? medicalRecord.habits.actividad_fisica
                      : ""
                  }
                  onChange={handleHabitChange}
                  disabled={!isEditing}
                ...
                <input
                  ...
                  value={
                    isEditing
                      ? newRecord.habits.tabaco
                      : medicalRecord
                      ? medicalRecord.habits.tabaco
                      : ""
                  }
                  onChange={handleHabitChange}
                  disabled={!isEditing}
                ...
                <input
                  ...
                  value={
                    isEditing
                      ? newRecord.habits.cafe
                      : medicalRecord
                      ? medicalRecord.habits.cafe
                      : ""
                  }
                  onChange={handleHabitChange}
                  disabled={!isEditing}
                ...
                <input
                  ...
                  value={
                    isEditing
                      ? newRecord.habits.sueño
                      : medicalRecord
                      ? medicalRecord.habits.sueño
                      : ""
                  }
                  onChange={handleHabitChange}
                  disabled={!isEditing}
                ...
                <input
                  ...
                  value={
                    isEditing
                      ? newRecord.habits.alimentacion
                      : medicalRecord
                      ? medicalRecord.habits.alimentacion
                      : ""
                  }
                  onChange={handleHabitChange}
                  disabled={!isEditing}
                ...
                <input
                  ...
                  value={
                    isEditing
                      ? newRecord.habits.sexuales
                      : medicalRecord
                      ? medicalRecord.habits.sexuales
                      : ""
                  }
                  onChange={handleHabitChange}
                  disabled={!isEditing}
              ...
              <div className="treatment-section">
                ...
                <button className="expand-toggle" onClick={handleToggleTreatments}>
                  {showTreatments ? "▲" : "▼"}{" "}
                  {showTreatments ? "Ocultar Tratamientos" : "Mostrar Tratamientos"}
                </button>
                <button className="expand-toggle" onClick={handleCreateTreatment}>
                  Crear Tratamiento
                </button>
                    ...
                    {treatments.map((treatment) => (
                      <div
                        ...
                        className={`treatment-item ${
                          newRecord.treatment === treatment._id ? "selected" : ""
                        }`}
                      >
                        <div className="treatment-header">
                          <div>
                            <strong>Descripción:</strong> {treatment.description || "No disponible"}
                          </div>
                          <button
                        ...
                        <div>
                          <strong>Dosis:</strong> {treatment.dose || "No disponible"}
                        </div>
                        <div>
                          <strong>Duración:</strong> {treatment.duration || "No disponible"}
                        </div>
                            ...
                            <div className="medicines-list">
                              {treatment.medicines.map((medicine) => (
                                <div key={medicine._id} className="medicine-item">
                                  <div>
                                    <strong>Nombre:</strong> {medicine.name || "No disponible"}
                                  </div>
                                  <div>
                                    <strong>Tipo:</strong> {medicine.type || "No disponible"}
                                  </div>
                                  <div>
                                    <strong>Uso:</strong> {medicine.use || "No disponible"}
                                  </div>
                                </div>
                              ))}
                            </div>
              ...
              <div className="external-exams-section">
                ...
                <button className="expand-toggle" onClick={handleToggleExternalExams}>
                  {showExternalExams ? "▲" : "▼"}{" "}
                  {showExternalExams ? "Ocultar Exámenes Externos" : "Mostrar Exámenes Externos"}
                </button>

                <button className="expand-toggle" onClick={handleOpenCreateExternalExamModal}>
                      ...
                      <ul className="external-exams-list">
                        {externalExams.map((exam) => (
                          ...
                          >
                            ...
                            <strong>Descripción:</strong> {exam.description || "No disponible"}{" "}
                            <br />
                            <strong>Fecha:</strong>{" "}
                            {new Date(exam.date).toLocaleDateString() || "No disponible"} <br />
                            <button
                              className="delete-treatment-btn"
                              onClick={(event) => {
