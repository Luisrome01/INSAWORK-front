...
import { FaPencilAlt, FaTimes } from "react-icons/fa"; // Importa el ícono de lápiz para editar
    ...
    <div className="paciente-modal-overlay">
      <div className="paciente-modal">
        <div className="pacienteHeaderModal">
          <h2 className="createMedicineModalTitle">Detalles del Paciente</h2>
          <div className="modalHeaderButtons">
          {!isEditing && (
              <button className="paciente-modal-edit-button" onClick={() => setIsEditing(true)}>
        ...
        <div className="paciente-modal-details">
          ...
          <p>
            ...
            {isEditing ? (
              <select name="gender" value={editedPatient.gender} onChange={handleInputChange}>
          ...
          <p>
            ...
            {isEditing ? (
              <select name="company" value={editedPatient.company} onChange={handleInputChange}>
              ...
              companies.find((company) => company._id === editedPatient.company)?.name ||
              "No asignada"
            )}
          </p>
          <p>
        ...
        {isHistoriaModalOpen && (
          <ModalHistoria
            ...
            onUpdateSuccess={() => {
              /* Aquí puedes manejar la actualización exitosa del modal historia */
            }}
          />
        )}
      </div>
